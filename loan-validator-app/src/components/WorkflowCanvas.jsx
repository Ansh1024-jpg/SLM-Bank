...
const initialNodes = [
  ...
  { id: '3', type: 'human', position: { x: 450, y: 500 }, data: { label: 'Human Review', subLabel: 'Email Correction', type: 'human', status: 'idle' } },
...
const WorkflowCanvas = ({ theme }) => {
  ...
  return (
    <div className="w-full h-full">
      ...
      >
        <Background color={theme === 'light' ? '#cbd5e1' : '#334155'} gap={20} size={1} />
